...
<body>
    <h1 style="text-align:center;">Добавление десертов в админ панели</h1>
<? 
    $sql=$pdo->prepare("SELECT * FROM deserts");
    $sql->execute();
    $res=$sql->fetch(PDO::FETCH_OBJ); ?>

    <div class="container">
        <form action="/admin/desert_create.php" class="form-signin" method="POST">
