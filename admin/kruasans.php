...
<body>
    <h1 style="text-align:center;"> Добавление круассанов в админ панели</h1>
<? 
    $sql=$pdo->prepare("SELECT * FROM kruassans");
    $sql->execute();
    $res=$sql->fetch(PDO::FETCH_OBJ); ?>

    <div class="container">
        <form action="/admin/kruasans_create.php" class="form-signin" method="POST">
